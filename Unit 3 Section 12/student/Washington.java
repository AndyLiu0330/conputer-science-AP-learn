...
public class Washington
{
   ...
   public static void printClassReport(){
   ...
   public static void printRegistration(){
        ...
        boolean quit = false; 
        do {
           System.out.print("Enter Student ID (WH999) for Inquiry (Q/q to quit): "); 
           String token = input.nextLine(); 
           //token = token.trim(); 
           for (int i=0; i<classSize; i++) {
               //System.out.println("T： "+token);
               //System.out.println("S: "+s[i].getID()); 
               if (token.equals(s[i].getID())) s[i].toScreen();
           }
           if (token.equals("Q") || token.equals("q")) quit = true; 
        } while (!quit); 
    }
   ...
   public static void main(String[] args) throws IOException {
        ...
        boolean quit = false; 
        do {
          System.out.println("\f    Washington High School Information System ");
          System.out.println("====================================================="); 
          System.out.println("          [C] Print Class Report ");
          System.out.println("          [S] Print Student Registration Record");
          System.out.println("          [Q] Quit");
          System.out.println(); 
          System.out.print("          Enter Your Choice:　");
          String token = input.nextLine(); 
          char tt = token.charAt(0); 
          switch (tt) {
            case 'C': 
            case 'c': printClassReport();  break; 
            case 'S': 
            case 's': printRegistration(); break; 
            case 'Q':
            case 'q': quit = true; 
           }
          if (!quit) {
              ...
              input.nextLine();
              System.out.println("Thank you for using Information System for Washington High School. ");
